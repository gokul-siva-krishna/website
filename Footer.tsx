        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <a
              ...
              className="text-white hover:text-company-lightgray transition-colors"
            >
              ...
              <a href="#" className="text-white hover:text-company-lightgray transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Test Jig Development</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">LabVIEW Programming</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Data Acquisition</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Automation Solutions</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Technical Consulting</a></li>
            </ul>
          </div>
        </div>
