      ...
      <section className="pt-20 pb-16 bg-gradient-to-r from-company-blue to-company-lightblue">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Automation Solutions</h1>
            <p className="text-xl mb-8 text-white/90">
              End-to-end automation of testing processes, reducing human error and increasing production efficiency
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 text-company-blue">Automation Services</h2>
